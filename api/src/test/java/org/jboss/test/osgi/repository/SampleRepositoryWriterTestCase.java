 ...
 * @since 21-May-2012
 */
public class SampleRepositoryWriterTestCase extends AbstractRepositoryTest {

    @Test
    public void testXMLReaderWriter() throws Exception {
        ...
        SampleRepositoryReaderTestCase.verifyContent(reader.getRepositoryAttributes(), getResources(reader));
    }
}