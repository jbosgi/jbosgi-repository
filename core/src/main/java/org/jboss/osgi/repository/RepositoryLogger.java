...
public interface RepositoryLogger extends BasicLogger {
    ...
    @Message(id = 20401, value = "Cannot create resource for: %s")
    void errorCannotCreateResource(@Cause Throwable th, String resid);

    @LogMessage(level = WARN)
    @Message(id = 20402, value = "Cannot infer value type from %s")
