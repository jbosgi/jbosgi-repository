...
public interface RepositoryMessages {
    ...
    @Message(id = 20520, value = "Cannot obtain required attribute: %s")
    IllegalArgumentException cannotObtainRequiredAttribute(String attrname);

    @Message(id = 20521, value = "Cannot obtain module resource: %s")
    IllegalArgumentException cannotObtainModuleResource(@Cause Throwable cause, ModuleIdentifier moduleId);

    @Message(id = 20522, value = "Cannot obtain metadata for resource: %s")
